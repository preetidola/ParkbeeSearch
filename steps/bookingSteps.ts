...
When('I select {string} from suggestions', 
  { timeout: 30000 },
  async function (this: CustomWorld, text: string) {
...
Then('I should be navigated to the search results page', { timeout: 30000 },
  async function (this: CustomWorld) {
    await this.page!.waitForURL(/maps-web-uat\.parkbee\.com/);
});

Then('I should see recommended location', { timeout: 60000 },
  async function (this: CustomWorld) {
...
Then('the map should be visible',{ timeout: 30000 }, async function (this: CustomWorld) {
